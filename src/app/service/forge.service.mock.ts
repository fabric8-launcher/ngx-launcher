import { Gui, MetaData, Option, State } from '../model/base.model';
  ...
  'state': [{
    ...
    'inputs': [{
      ...
      'valueChoices': [{
        ...
        'name': 'Release',
        'description': '<p>Maven based pipeline which:</p>\n<ul>\n<li>creates a new version then builds and ' +
        'deploys the project into the maven repository</li>\n<li>runs an integration test in the <strong>' +
        'Test</strong> environment</li>\n</ul>\n'
      }, {
        'id': 'Release and Stage',
        'builder': 'maven',
        'descriptionMarkdown': 'Maven based pipeline which:\n\n* creates a new version then builds and ' +
        'deploys the project into the maven repository\n* runs an integration test in the **Test** ' +
        ...
        'description': '<p>Maven based pipeline which:</p>\n<ul>\n<li>creates a new version then ' +
        'builds and deploys the project into the maven repository</li>\n<li>runs an integration test ' +
        'in the <strong>Test</strong> environment</li>\n<li>stages the new version into the ' +
        '<strong>Stage</strong> environment</li>\n</ul>\n'
      }, {
        ...
        'description': '<p>Maven based pipeline which:</p>\n<ul>\n<li>creates a new version then builds ' +
        'and deploys the project into the maven repository</li>\n<li>runs an integration test in the ' +
        '<strong>Test</strong> environment</li>\n<li>stages the new version into the <strong>Stage</strong>' +
        ' environment</li>\n<li>waits for <strong>Approval</strong> to promote </li>\n<li>promotes to the ' +
        '<strong>Run</strong> environment</li>\n</ul>\n'
      }],
      'class': 'UISelectOne',
